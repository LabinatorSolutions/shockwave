...
import { transcribeVoice, listenKey, type VoiceConfig } from '../../../agent-core/transcribe.js';

export { warmTranscription } from '../../../agent-core/transcribe.js';
export { listenProviderOf, voiceLabel } from '../../../agent-core/voiceProviders.js';
 ...
 *
 * Takes the whole voice config rather than a key, because which key applies
 * depends on which vendor is selected for listening, and that is
 ...
 * clip fits AssemblyAI's sync ceiling, and it costs nothing to pass. Deepgram and
 * ElevenLabs have no such ceiling and ignore it.
 *
