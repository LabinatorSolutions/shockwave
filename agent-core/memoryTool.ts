...
//
// Everything else is untouched: the four labelled paragraphs (HOW / WHEN / IF
// FULL / TARGETS / SKIP), the instruction to prefer ONE batch call, the priority
// order, and the closing rule that reusable procedures are a skill and not a
// memory. Do not tidy this text — the "don't repeat it" clause and the
...
export const MEMORY_TOOL_DESCRIPTION =
  ...
  + 'completed-work logs, temporary TODO state (use search_chats for those). Reusable '
